...
public class JapaneseFoodAdapter extends RecyclerView.Adapter<JapaneseFoodAdapter.ViewHolder> {
    ...
    JapaneseFoodAdapter(Context context, ArrayList<com.example.minimart.ModelFood> list){
        mcontext=context;
        modelFoods=list;
    }
    public  class  ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            itemImage = itemView.findViewById(R.id.item_image_japan1);
            item_name = itemView.findViewById(R.id.item_name_japan1);
            item_place = itemView.findViewById(R.id.item_place_japan1);
            item_price = itemView.findViewById(R.id.item_price_japan1);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_foods_6,parent,false);
