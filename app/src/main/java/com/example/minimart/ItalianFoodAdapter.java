...
public class ItalianFoodAdapter extends RecyclerView.Adapter<ItalianFoodAdapter.ViewHolder> implements  View.OnClickListener{
    com.example.minimart.ItemClickListener itemClickListener;
    TextView textView,Des;
    public static ArrayList<ModelStoreFood> modelStoreFoods = new ArrayList<ModelStoreFood>();
    public static ArrayList<com.example.minimart.ModelFood> modelFoods;
    public ModelStoreFood foodItem;
    com.example.minimart.ModelFood modelFood;
    private Context mcontext;
    ItalianFoodAdapter(Context context, ArrayList<com.example.minimart.ModelFood> list){
        mcontext=context;
        modelFoods=list;
    }
    ...
    public  class  ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            itemImage = itemView.findViewById(R.id.item_image_italian1);
            item_name = itemView.findViewById(R.id.item_name_italian1);
            item_place = itemView.findViewById(R.id.item_place_italian1);
            item_price = itemView.findViewById(R.id.item_price_italian);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_foods_4,parent,false);
